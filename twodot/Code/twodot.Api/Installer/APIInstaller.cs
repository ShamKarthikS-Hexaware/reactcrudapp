...
using ElmahCore.Mvc;
using ElmahCore;
using twodot.Api.Filters;
using twodot.Business.Installer;

namespace twodot.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "twodot API", Version = version + "-" + branch});
            });
