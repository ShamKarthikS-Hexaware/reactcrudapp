...
using ElmahCore.Mvc;
using ElmahCore;
using onedot.Api.Filters;
using onedot.Business.Installer;

namespace onedot.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "onedot API", Version = version + "-" + branch});
            });
