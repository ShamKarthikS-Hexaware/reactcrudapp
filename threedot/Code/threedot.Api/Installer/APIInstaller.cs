...
using ElmahCore.Mvc;
using ElmahCore;
using threedot.Api.Filters;
using threedot.Business.Installer;

namespace threedot.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "threedot API", Version = version + "-" + branch});
            });
